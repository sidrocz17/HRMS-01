// src/components/holiday/DeleteConfirm.jsx

export default function DeleteConfirm({ holidayName, onConfirm, onCancel }) {
    ...
    >
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-2xl overflow-hidden">
        <div className="flex flex-col items-center px-6 pt-8 pb-4 text-center">
          ...
          <h3 className="text-base font-bold text-gray-900 mb-1">Delete Holiday</h3>
          <p className="text-sm text-gray-500 leading-relaxed">
            Are you sure you want to delete{" "}
            <span className="font-semibold text-gray-800">"{holidayName}"</span>?
